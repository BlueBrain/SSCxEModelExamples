    ...
    for protocol_name, protocol_definition in protocol_definitions.items():
        ...
        for stimulus_definition in protocol_definition['stimuli']:
            ...
            if protocol_name in ["IDthresh_200","IDRest_200","IV_-100.0"] : 
                    stimuli.append(ephys.stimuli.NrnSquarePulse(step_amplitude=stimulus_definition['amp'],
                                                                step_delay=stimulus_definition['delay'],
                                                                step_duration=stimulus_definition['duration'],
                                                                location=soma_loc,
                                                                total_duration=stimulus_definition['totduration']))
            elif protocol_name in ["APThreshold_200","APThreshold_170","APThreshold_220","APThreshold_250","APThreshold_300","APThreshold_150","APThreshold_400","APThreshold_430","APThreshold_330","APThreshold_390"]: 
    ...
    for protocol_name, locations in feature_definitions.items():
        for location, features in locations.items():
            for efel_feature_name, meanstd in features.items():
                ...
                if protocol_name in ["APThreshold_100","APThreshold_170","APThreshold_220","APThreshold_250","APThreshold_200","APThreshold_300","APThreshold_150","APThreshold_400","APThreshold_330","APThreshold_430","APThreshold_390"]:
                ...
                if protocol_name in ["APThreshold_100","APThreshold_170","APThreshold_220","APThreshold_250","APThreshold_200","APThreshold_300","APThreshold_150","APThreshold_400","APThreshold_430","APThreshold_330","APThreshold_390"]:
                ...
                elif protocol_name in ["APThreshold_100","APThreshold_170","APThreshold_200","APThreshold_250","APThreshold_220","APThreshold_300","APThreshold_150","APThreshold_400","APThreshold_430","APThreshold_330","APThreshold_390"]: 
                      stim_end = stimulus.ramp_delay + stimulus.ramp_duration
                else:
                    stim_end = stimulus.step_delay + stimulus.step_duration
                
                features_sAHP=['AHP_depth_abs',
                             'sag_amplitude',
                             'sag_ratio1', 
                ...
                if protocol_name[:-4]=="IDhyperpol" and efel_feature_name in ['sag_amplitude','sag_ratio1','minimum_voltage', 'steady_state_voltage_stimend']:              
...
def create(morpho_path,path_params, path_features, path_protocols):
    ...
    fitness_calculator = define_fitness_calculator(fitness_protocols,
                                                   path_features)
    param_names = [param.name for param in cell.params.values()
                   if not param.frozen]
